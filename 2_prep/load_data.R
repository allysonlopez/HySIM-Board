...
# determines when patients enter the simulation
interarrival_data <- read_csv_file("01_interarrival_by_timeblock_hourly_cy2025.csv")

# used to assign characteristics to each simulated patient
case_mix_data <- read_csv_file("02_case_mix_by_timeblock_cy2025.csv")

# used to determine first provider wait times
...
# used to determine workup durations
